    ...
    return (
        <div className={classes.container} style={{backgroundColor: 'rgba(0, 0, 0, 0.3)', overflowY: 'auto'}}>
            <div className="flex flex-col lg:flex-row h-full">
                <div className="lg:m-2 pt-2 text-left w-full h-full" style={{backgroundColor: 'rgba(0, 0, 0, 0.8)', fontFamily: 'Helvetica'}}>
                    ...
                    <div className="mt-1 mb-2 px-2 md:px-4 lg:px-4 lg:w-1/2 lg:mx-auto text-center text-white text-sm sm:text-sm md:text-lg lg:text-lg" style={{fontFamily: 'Helvetica', letterSpacing: '1px'}}>
                        ...
                        <br />
                        <div className="mt-8 text-lg">Call to schedule an appointment!</div>
                    </div>
                    ...
                    <div className="w-full text-center">
                            ...
                            <button type="button" className="p-1 bg-green-900" style={{borderRadius: '10px', border: '2px solid white'}}>
                                ...
                                <span className="font-bold text-white" style={{fontFamily:'CortisaProLight', letterSpacing: '1px'}} onClick={() => {window.open(patientPDF)}}>NEW PATIENT FORM</span>
                            </button>
                    ...
                    <div className="w-full p-4">
                        ...
                        <div className="h-8 mx-6 text-center text-green-300 text-sm sm:text-sm md:text-sm lg:text-sm" style={{fontFamily: 'CortisaProLight', letterSpacing: '2px'}}>
